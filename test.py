...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.btn1.move(350,350)
        self.btn1.clicked.connect(self.update_plot_data1)
        self.stp1 = QtWidgets.QPushButton("Stop", self)
        self.stp1.move(450,350)
        self.stp1.clicked.connect(self.stop_update_plot_data1)
